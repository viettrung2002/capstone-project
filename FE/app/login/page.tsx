...
export default function LoginPage() {
    ...
    return (
        <div className={`flex w-full items-center justify-center py-[40px] bg-gray-50 `}>
            <div className={`w-[500px] h-[600px] rounded-[5px] shadow-[0px_0px_5px_rgba(0,0,0,0.2)] flex flex-col items-center bg-white`}>
                ...
                <div className={`w-[400px] h-[45px]  mt-[30px] grid grid-cols-10 gap-[10px] rounded-[4px]`}>
                    ...
                    <div className={`col-span-3 flex rounded-[4px] bg-blue-500 justify-center items-center hover:bg-gray-700 transition-all duration-200`}>
