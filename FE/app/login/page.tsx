...
export default function LoginPage() {
    ...
    return (
        <div className={`flex w-full items-center justify-center relative bg-white flex-col pt-[40px]`}>
            ...
            {openNotification && (
                <div className={"absolute px-[20px] py-[10px] border border-stone-200 rounded-[25px] bg-white top-[-70px] flex flex-col items-center z-50"}>
                    <p>Sai tên đăng nhập hoặc mật khẩu</p>
                    <button onClick={()=>setOpenNotification(false)} className={"px-[15px] bg-stone-200 py-[3px] w-[80px] rounded-full mt-[10px]"}>
                        Ok
                    </button>
                </div>
            )}
            ...
            <div className={`w-[500px] rounded-[25px] border border-stone-200 flex flex-col items-center bg-white mb-[50px] pb-[40px]`}>
                ...
                <div className={`w-[400px] flex flex-col mt-[10px]`}>
                    <span className={`font-sf text-amber-600 font-[400] text-[15px] select-none`}>Quên mật khẩu?</span>
                </div>
