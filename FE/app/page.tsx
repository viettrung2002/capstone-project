        ...
        <div className="Home bg-gray-50 pt-[90px] flex flex-col items-center">
            <div className="h-[60px] w-full border-b border-gray-300 flex flex-row items-center justify-center">
                <div className="flex flex-row 2xl:w-[1400px] xl:w-[1280px]  h-full">
                    <div className="flex flex-row w-[200px] h-full border-r border-gray-300 items-center relative"
                        ...
                        <p className={`font-fre text-cl-text text-[18px] ml-[10px] font-[500] select-none`}>Categories</p>
                        {isOpen?
                            (
                                <ul className={`bg-gray-50 absolute top-[62px] border border-gray-200 w-[200px] pl-[30px] pt-[10px] pb-[10px] text-cl-text z-30`}>
                                    <li className={`flex items-center w-full h-[35px] font-fre font-[400] text-[16px] hover:text-cl-hover-text `}>Smartphone</li>
                                    <li className={`flex items-center w-full h-[35px] font-fre font-[400] text-[16px] hover:text-cl-hover-text `}>Laptop</li>
                                    <li className={`flex items-center w-full h-[35px] font-fre font-[400] text-[16px] hover:text-cl-hover-text `}>Watch</li>
                                    <li className={`flex items-center w-full h-[35px] font-fre font-[400] text-[16px] hover:text-cl-hover-text `}>Television</li>
                                    <li className={`flex items-center w-full h-[35px] font-fre font-[400] text-[16px] hover:text-cl-hover-text `}>Video games</li>
                                    <li className={`flex items-center w-full h-[35px] font-fre font-[400] text-[16px] hover:text-cl-hover-text `}>Camera</li>
                                    <li className={`flex items-center w-full h-[35px] font-fre font-[400] text-[16px] hover:text-cl-hover-text `}>Headphone</li>
                    ...
                    <div className=" w-[700px] flex flex-row text-cl-text">
                        <p className={`select-none flex items-center h-full font-fre font-[500] text-[17px]  hover:text-cl-hover-text ml-[30px]`}>Home</p>
                        <p className={`select-none flex items-center h-full font-fre font-[500] text-[17px]  hover:text-cl-hover-text ml-[30px]`}>Vouchers</p>
                        <p className={`select-none flex items-center h-full font-fre font-[500] text-[17px]  hover:text-cl-hover-text ml-[30px]`}>Top Products</p>
                        <p className={`select-none flex items-center h-full font-fre font-[500] text-[17px]  hover:text-cl-hover-text ml-[30px]`}>Seller Channel</p>

                    </div>

                    <ul className="ml-auto h-full flex flex-row text-cl-text items-center">
                        <li className={`select-none flex items-center h-full font-fre font-[500] text-[17px]  ml-[30px]`}>Contact us:</li>
                    ...
                    <div className={`col-span-1 grid grid-rows-2 gap-[20px]`}>
                        <div className={`flex flex-col col-span-1 relative justify-center `}>
                            <div className={`z-10 ml-[30px]`}>
                                <p className={`font-fre text-gray-500 text-[16px]`}>New line required</p>
                                <p className={`font-fre font-[600] text-cl-text text-[22px]`}>iPhone 12 Pro Max</p>
            ...
            <div className="2xl:w-[1400px] xl:w-[1280px]  flex items-center justify-center mt-[100px]">
                <div className={`w-[600px] flex flex-col items-center`}>
                    <p className={`font-fre font-[500] text-[30px] text-cl-text`}>Featured Categories</p>
                    <div className={`border-b border-[2px] border-blue-600 w-[50px] mt-[4px]`}></div>
                    <p className={`text-center font-fre font-[400] text-gray-500 mt-[20px]`}>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form.</p>
                </div>
            ...
            <div className="2xl:w-[1400px] xl:w-[1280px]  flex items-center justify-center mt-[100px]">
                <div className={`w-[600px] flex flex-col items-center`}>
                    <p className={`font-fre font-[500] text-[30px] text-cl-text`}>Flash sale</p>
                    <div className={`border-b border-[2px] border-blue-600 w-[50px] mt-[4px]`}></div>
                    <p className={`text-center font-fre font-[400] text-gray-500 mt-[20px]`}>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form.</p>
                </div>
            </div>
            ...
            <div className={` 2xl:w-[1400px] xl:w-[1280px] mt-[30px] relative `}>
                <div className={`h-[50px] w-full pr-[60px] pl-[60px] mb-[20px]  flex items-center justify-between`}>
                    <div className={`w-[200px] h-[50px] flex shadow rounded-[4px] pl-[25px] bg-white flex items-center`}>
                        <p className={`font-[500] font-fre text-[18px] text-gray-500`}>End in:</p>
                        <p className={`font-[500] font-fre text-[20px] text-gray-700 ml-[10px]`}>{formatTime(timeLeft)}</p>
                    </div>
                    <button className={`flex items-center text-gray-700 hover:text-blue-600`}>
                        <p className={`font-[400] font-fre text-[18px] `}>See more</p>
                        <HiArrowRight className={`text-[20px] ml-[6px] mt-[2px]`}/>
                    </button>
                ...
                <div className={`flex h-full w-full justify-center items-center  relative`}>
                    ...
                    <div className={` w-[calc(100%-100px)] relative overflow-hidden`}>
                        <div
                            className={`w-full grid gap-[10px] grid-cols-6 flex p-[10px] relative items-center transition-transform `}
            ...
            <div className="2xl:w-[1400px] xl:w-[1280px]  flex items-center justify-center mt-[70px]">
                <div className={`w-[600px] flex flex-col items-center`}>
                    <p className={`font-fre font-[500] text-[30px] text-cl-text`}>Trending products</p>
                    <div className={`border-b border-[2px] border-blue-600 w-[50px] mt-[4px]`}></div>
                    <p className={`text-center font-fre font-[400] text-gray-500 mt-[20px]`}>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form.</p>
                </div>
