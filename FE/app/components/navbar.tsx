...
export default function Navbar() {
    ...
    return (
                ...
                <nav className=" bg-white sticky top-0 w-full h-[70px] z-50 border-gray-300 border-b items-center flex-row flex justify-center  pb-[0px] shadow-[0px_2px_4px_rgba(0,0,0,0.1)]">
                    <div className=" w-[1400px] flex items-center justify-between ">
                        ...
                        <div className={`grid grid-cols-9 gap-[10px] h-[45px]`}>
                            <button className={`flex col-span-2 rounded-full border border-gray-300 justify-center items-center transition duration-300 text-gray-700 hover:bg-blue-500 hover:text-gray-50`}>
