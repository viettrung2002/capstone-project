    ...
    return (
        <div  className={` col-span-1 aspect-[65/100] bg-white pb-[10px]`}>
            <div
                ...
                <button onClick={() => AddToCart(product.productId, router )} className={`absolute w-[130px] h-[40px] hover:bg-neutral-700 bg-blue-500 rounded-[4px] bottom-[30px] flex items-center justify-center transition-all duration-200 translate-y-[75px] opacity-0 ease-in-out group-hover:opacity-100 group-hover:translate-y-0 `}>
                    <HiOutlineShoppingCart className={`text-cl-button-text text-[20px]`}/>
                    <p className={`ml-[5px] text-cl-button-text font-sf text-[15px] `}>Thêm vào giỏ</p>
                </button>
        ...
        <div onClick={()=>router.push(`/product/${product.productId}`)} className={`col-span-1 w-full bg-white  flex flex-col hover:shadow-md`}>
            ...
            <div className={`flex-1 `}>
                <div className={"flex flex-col justify-center items-center"}>
                    <p className={`font-sf mt-[10px] text-stone-900 text-[15px] font-[500] uppercase`}>{product.productName}Samsung Galaxy S35 Ultra</p>
                    <div className={`flex items-center h-[20px] text-[15px] mb-[5px]`}>
                        ...
                        <p className={`font-sf text-neutral-500 ml-[10px] text-[14px] `}>{product.reviewCount} Review</p>
                    </div>
                    {product.discount > 0 ? (
                        <div className={`flex items-center`}>
                            <p className={`font-sf text-cl-hover-text text-[18px] font-[600] `}>${product.price - product.price * product.discount / 100}  </p>
        ...
        <div className={"col-span-1 h-[125px] bg-white box-content  flex rounded-[8px] shadow-md"}>
            ...
            <div className={"flex w-[calc(100%-125px)] flex-col  flex-1 font-sf  pr-[10px] py-[10px]"}>
                ...
                <div className={"flex h-[20px]"}>
                    ...
                    <p className={"text-[13px] text-neutral-700"}>23 sản phẩm</p>
                </div>
                <div className={"h-[32px] w-full flex mt-[3px]"}>
                    <button className={"h-full aspect-square items-center justify-center flex bg-neutral-200 text-neutral-800 mr-[5px] rounded-full text-[18px]"}>
                        <TbEdit/>
                    </button>
